 ...
 * @author 7oda
 */
public class add_patient2 extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (getID.isEmpty() || getFname.isEmpty() || getLname.isEmpty() || getAge.isEmpty() || getGender.isEmpty() || getPhone.isEmpty() || getAddress.isEmpty() || getDays.isEmpty() || getjoin.isEmpty() || getBed.isEmpty()) {
        ...
        if (s == "null") {
            ...
            try {
                ...
                String sqlStmt = "INSERT INTO `patient`(`id`, `fname`, `lname`, `age`, `blood`, `gender`, `joinDate`, `address`, `phone`, `disease`, `days`, `BedNO`,image) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                stmt.setString(5, getBlood);
                stmt.setString(6, getGender);
                stmt.setString(7, getjoin);
                stmt.setString(8, getAddress);
                stmt.setString(9, getPhone);
                stmt.setString(10, getDisease);
                stmt.setString(11, getDays);
                stmt.setString(12, getBed);
                System.out.println(photo.getIcon());
                if (photo.getIgnoreRepaint()) {
                    Toolkit.getDefaultToolkit().beep();   // alert
                    JOptionPane.showMessageDialog(this, "Notic\n Your Data will be saved without photo", "Failure", JOptionPane.ERROR_MESSAGE);
                } else {
                    stmt.setBlob(13, Is);
    ...
    private void browseMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_browseMouseEntered
        // TODO add your handling code here:
        browse.setBackground(new Color(153, 255, 153));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
         this.hide();
        new update_patient_rec().setVisible(true);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        this.hide();
        new delete_patient2().setVisible(true);
    ...
    private void daysMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_daysMouseClicked
        ...
        try {
            ...
            Date pcDate = format.parse(dat);
            Date joindate = format.parse(getJoin);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_patient2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_patient2().setVisible(true);
            }
        });
    }
