 ...
 * @author 7oda
 */
public class view_patient2 extends javax.swing.JFrame {

    String s;

    public view_patient2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 130, 1210, 270);
        ...
        jLabel3.setBounds(70, 590, 50, 50);
        ...
        search_id.setBounds(140, 590, 240, 50);
       ...
       int select = -1;  // if user doesn't select any row
        ...
        if (select >= 0) {
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "SELECT `image` FROM `patient` WHERE id = '" + id + "'";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                ResultSet rs = stmt.executeQuery();
                if (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_patient2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
