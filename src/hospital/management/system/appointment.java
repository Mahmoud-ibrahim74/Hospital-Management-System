...
public class appointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        display_data.setBounds(80, 140, 160, 50);
        ...
        jScrollPane1.setBounds(10, 220, 1210, 290);
        ...
        jLabel2.setBounds(470, 110, 170, 30);

        next.setBackground(new java.awt.Color(255, 255, 255));
        next.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        next.setText("Next");
    ...
    private void display_dataMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_dataMouseEntered
        // TODO add your handling code here:
        display_data.setBackground(new Color(255, 51, 51));
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        ...
        if (selcet >= 0) {
            String get = table.getValueAt(selcet, 2).toString() + " " + table.getValueAt(selcet, 3).toString();
            this.hide();
            new appointment2(get).setVisible(true);
