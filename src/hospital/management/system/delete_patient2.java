 ...
 * @author 7oda
 */
public class delete_patient2 extends javax.swing.JFrame {

    String s;

    public delete_patient2() {
        initComponents();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (getID.isEmpty()) {
            ...
            try {
                ...
                String sqlStmt = "DELETE FROM `patient` WHERE id = '" + getID + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_patient2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
