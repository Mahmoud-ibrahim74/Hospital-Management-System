...
public class update_doctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setBounds(920, 590, 100, 24);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (getID.isEmpty()) {
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "Update doctor SET `department`='" + getDep + "',`fname`='" + getFname + "',`lname`='" + getLname + "',`age`='" + getAge + "',`blood`='" + getBlood + "',`gender`='" + getGender + "',`phone`='" + getPhone + "',`email`='" + getEmail + "',`address`='" + getAddress + "',`city`='" + getCity + "',`days`='" + getDays + "',`joinDate`='" + getjoin + "',`leaveDate`='" + getLeave + "',`username`='" + getUsername + "',`password`='" + getPassword + "' WHERE id =" + getID + "";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                stmt.executeUpdate();
