 ...
 * @author 7oda
 */
public class update_patient_doc extends javax.swing.JFrame {

    String s;

    public update_patient_doc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        view_data.setBounds(470, 30, 160, 50);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        String getTablet = medicine.getSelectedItem().toString();
        String getRef = ref.getText();
        String getDialy = dialy.getText();
        String getDose = dose.getText();
        String getSildeEffect = se.getText();
        ...
        if (getID.isEmpty()) {
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "UPDATE `patient_for_doctor` SET `fname`='" + getFname + "',`lname`='" + getLname + "',`age`='" + getAge + "',`blood`='" + getBlood + "',`gender`='" + getGender + "',`joinDate`='" + getjoin + "',`address`='" + getAddress + "',`phone`='" + getPhone + "',`disease`='" + getDisease + "',`days`='" + getDays + "',`BedNO`='" + getBed + "',`Name_of_tablet`='" + getTablet + "',`ref`='" + getRef + "',`dialy_dos`='" + getDialy + "',`dosMG`='" + getDose + "',`Slide_Effect`='" + getSildeEffect + "',`Company`='" + getCompany + "' WHERE id = '"+getID+"'";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                stmt.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_patient_doc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
