...
public class doctor_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logout1.setBounds(1100, 10, 40, 20);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/doc.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } else if (getUsername.isEmpty() || getPassword.isEmpty()) // if one of two fields is empty
        {
            ...
            try {
                ...
                String sqlStmt = "SELECT  `password` FROM `doctor` WHERE username = '"+getUsername+"' ";
