...
public class staff extends javax.swing.JFrame {
    ...
    public staff() {
        ...
        panel.setBackground(new Color(51, 51, 255, 20)); // to Opacity Jpanel 2
    ...
    private void initComponents() {
        ...
        kGradientPanel1.setkEndColor(new java.awt.Color(162, 227, 248));
        ...
        txt.setText("LOWER STAFF DETAILS");
        panel.add(txt);
        ...
        panel2.setBackground(new java.awt.Color(168, 200, 233));
        ...
        panel2.add(gender);
        gender.setBounds(510, 100, 160, 40);

        jLabel13.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Gender");
        panel2.add(jLabel13);
        jLabel13.setBounds(420, 100, 80, 40);

        phone.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        phone.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        panel2.add(phone);
        phone.setBounds(510, 170, 160, 30);

        jLabel14.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Phone No.");
        panel2.add(jLabel14);
        jLabel14.setBounds(410, 160, 100, 40);

        type.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        type.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " Select STAFF", " Healthcare Assistants", " Nurses", " Physicians", " Pharmacists", " Technicians", " Clerical Staff" }));
        type.setBorder(null);
        panel2.add(type);
        type.setBounds(510, 220, 170, 40);

        kGradientPanel1.add(panel2);
        panel2.setBounds(50, 170, 820, 270);
        ...
        table.setBackground(new java.awt.Color(162, 227, 248));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "fname", "lname", "address", "city", "age", "gender", "phone", "Staff_type"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Long.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.String.class, java.lang.Long.class, java.lang.String.class
            };
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (getID.isEmpty() || getFname.isEmpty() || getLname.isEmpty() || getAge.isEmpty() || getType.isEmpty() || getGender.isEmpty() || getPhone.isEmpty() || getAddress.isEmpty() || getCity.isEmpty() || getType.isEmpty()) {
        ...
        if (s == "null") {
            ...
            try {
                ...
                String sqlStmt = "INSERT INTO `staff`(`id`, `fname`, `lname`, `address`, `city`, `age`, `gender`, `phone`, `staff_type`, `image`) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    private void addMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseEntered
        add.setBackground(new Color(168, 200, 233));
    ...
    private void deleteMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseEntered
        // TODO add your handling code here:
        delete.setBackground(new Color(168, 200, 233));
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (getID.isEmpty()) {
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "DELETE FROM `staff` WHERE id = '" + getID + "'";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                stmt.executeUpdate();
    ...
    private void updateMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseEntered
        // TODO add your handling code here:
        update.setBackground(new Color(168, 200, 233));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if (getID.isEmpty()) {
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "UPDATE `staff` SET `fname`='" + getFname + "',`lname`='" + getLname + "',`address`='" + getAddress + "',`city`='" + getCity + "',`age`='" + getAge + "',`gender`='" + getGender + "',`phone`='" + getPhone + "',`staff_type`='" + getType + "' WHERE id='" + getID + "'";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                stmt.executeUpdate();
    ...
    private void browseMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_browseMouseEntered
        // TODO add your handling code here:
        browse.setBackground(new Color(168, 200, 233));
    ...
    private void display_dataMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_dataMouseEntered
        // TODO add your handling code here:
        display_data.setBackground(new Color(168, 200, 233));
    ...
    private void display_dataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_display_dataActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
            String sqlStmt = "SELECT `id`, `fname`, `lname`, `address`, `city`, `age`, `gender`, `phone`, `staff_type` FROM `staff`";
            PreparedStatement stmt = con.prepareStatement(sqlStmt);
    ...
    private void resetMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetMouseEntered
        reset.setBackground(new Color(168, 200, 233));
    ...
    private void resetData() {
        type.setSelectedItem(" Select STAFF");
    ...
    private void showData() {
        ...
        if (selected >= 0) {
            ...
            type.setSelectedItem((model.getValueAt(selected, 8).toString()));
        ...
        if (select >= 0) {     // if user doesn't select any row
            try {
                String id = table.getValueAt(select, 0).toString(); // get id from jtable
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hms", "root", "");
                String sqlStmt = "SELECT `image` FROM `staff` WHERE id = '" + id + "'";
                PreparedStatement stmt = con.prepareStatement(sqlStmt);
                ResultSet rs = stmt.executeQuery();
                if (rs.next()) {
